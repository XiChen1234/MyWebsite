...
const games: Game[] = [
  {
    ...
    path: '/game/paws_up/',
    bgColor: '#4baec0',
    detailedDescription: 'Paws Up! 是一款轻松治愈的节奏音游。玩家跟随音乐节拍，使用 Space 施展猫猫拳、使用 Enter 发出猫猫哈气，精准打击出现的音符以获得判定与分数。支持音画延迟校准与多种难度，连击会提升得分与评级，错失音符会打断连击。完成曲目后将显示分数、评级与连击统计。游戏节奏明快、风格可爱，既适合新手入门，也适合资深节奏玩家放松娱乐。',
    rules: [
      '使用Space控制猫猫拳',
      '使用Enter控制猫猫哈气',
