...
const games: Game[] = [
  ...
  },
  {
    ...
    path: '/game/tetris/',
    bgColor: '#4a90e2',
    detailedDescription: '俄罗斯方块是一款经典的益智游戏，玩家需要控制下落的方块，将它们堆叠成完整的行，当一行被填满时会自动消除，获得分数。游戏速度会逐渐加快，考验玩家的反应能力和空间规划能力。',
    rules: [
      '使用方向键控制方块左右移动',
      '使用向下键加速下落',
      '使用上键或空格键旋转方块',
  ...
  },
  {
    ...
    path: '/game/sudoku/',
    bgColor: '#f5a623',
    detailedDescription: '数独是一款经典的数字填充游戏，玩家需要在9x9的九宫格中填入1-9的数字，使得每行、每列和每个3x3的小九宫格中都包含1-9的所有数字，且不重复。游戏需要玩家运用逻辑推理能力，逐步填充数字。',
    rules: [
      '每行必须包含1-9的所有数字，不重复',
      '每列必须包含1-9的所有数字，不重复',
      '每个3x3的小九宫格必须包含1-9的所有数字，不重复',
      '根据已知数字推理未知数字',
      '填满所有空格获胜'
    ],
    tips: [
  ...
  },
  {
    ...
    path: '/game/breakout/',
    bgColor: '#e95793',
    detailedDescription: '打砖块是一款经典的街机游戏，玩家控制底部的挡板，反弹球来击碎顶部的砖块。游戏目标是击碎所有砖块，同时保持球不落地。随着游戏进行，砖块会变得更加坚固，需要多次击打才能击碎。',
    rules: [
      '使用方向键或鼠标移动挡板',
      '反弹球来击碎顶部的砖块',
      '球落地时失去一条生命',
